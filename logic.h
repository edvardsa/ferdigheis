...
//set next floor based on nearest and most favorable order and returns 1
...
//set next floor based on the nearest and most favorable order below and returns 1
...
//calls check_order_below() or check_order_above() based on current direction, last direction and current floor
void set_priority();

//returns sum of orders in the order matrix
int sum_of_orders();
...
*/
//Hold-up function for the elevator door lamp. 
